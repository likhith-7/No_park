...
def SEND1():
    today = datetime.now()
    today = datetime.now()
    msg = 'Violoation Detected at {}'.format(today)
    client = Client("ACa5d38347e9f8678466737e9a954c7eef","54b355feb23794927bc10ac8eda2f0e1")
    client.messages.create(to="+917406944272",from_="+12055709078",body=msg)
